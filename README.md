...
## Environments
- Preview: https://main--bhellema-lifelock--aemysites.aem.page/
- Live: https://main--bhellema-lifelock--aemysites.aem.live/
- Block Library: https://main--bhellema-lifelock--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `bhellema-lifelock` directory in your favorite IDE and start coding :)
